...
// Make the styling show up ie CSS
...
app.post("/submit", (req, res) => {
  ...
  let randomIndex1 = Math.floor(Math.random() * adj.length);
  let randomIndex2 = Math.floor(Math.random() * noun.length);

  res.render("index.ejs", {
    randomAdj: adj[randomIndex1],
    randomNoun: noun[randomIndex2],
    current_year: current_year,
  });
});
